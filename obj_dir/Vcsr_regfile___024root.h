...
#ifndef VERILATED_VCSR_REGFILE___024ROOT_H_
#define VERILATED_VCSR_REGFILE___024ROOT_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vcsr_regfile___024root final : public VerilatedModule {
  public:
    ...
    IData/*31:0*/ tb_csr_regfile__DOT__dut__DOT__mtval;
    ...
    // CONSTRUCTORS
    Vcsr_regfile___024root(Vcsr_regfile__Syms* symsp, const char* v__name);
    ~Vcsr_regfile___024root();
    VL_UNCOPYABLE(Vcsr_regfile___024root);
