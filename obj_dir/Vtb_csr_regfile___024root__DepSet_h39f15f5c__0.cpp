...
VL_INLINE_OPT VlCoroutine Vtb_csr_regfile___024root___eval_initial__TOP__Vtiming__0(Vtb_csr_regfile___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtb_csr_regfile__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_csr_regfile___024root___eval_initial__TOP__Vtiming__0\n"); );
    // Body
    ...
    if (VL_UNLIKELY((0U != vlSelf->tb_csr_regfile__DOT__csr_rdata))) {
        VL_WRITEF("[%0t] %%Fatal: tb_csr_regfile.v:151: Assertion failed in %Ntb_csr_regfile: RESET FAILED: MSTATUS\n",
                  64,VL_TIME_UNITED_Q(1000),-9,vlSymsp->name());
        VL_STOP_MT("tb/tb_csr_regfile.v", 151, "");
    }
    vlSelf->tb_csr_regfile__DOT__csr_raddr = 0x305U;
    co_await vlSelf->__VdlySched.delay(0x3e8ULL, nullptr, 
                                       "tb/tb_csr_regfile.v", 
                                       154);
    if (VL_UNLIKELY((0U != vlSelf->tb_csr_regfile__DOT__csr_rdata))) {
        VL_WRITEF("[%0t] %%Fatal: tb_csr_regfile.v:156: Assertion failed in %Ntb_csr_regfile: RESET FAILED: MTVEC\n",
                  64,VL_TIME_UNITED_Q(1000),-9,vlSymsp->name());
        VL_STOP_MT("tb/tb_csr_regfile.v", 156, "");
    }
    vlSelf->tb_csr_regfile__DOT__csr_raddr = 0x341U;
    co_await vlSelf->__VdlySched.delay(0x3e8ULL, nullptr, 
                                       "tb/tb_csr_regfile.v", 
                                       159);
    if (VL_UNLIKELY((0U != vlSelf->tb_csr_regfile__DOT__csr_rdata))) {
        VL_WRITEF("[%0t] %%Fatal: tb_csr_regfile.v:161: Assertion failed in %Ntb_csr_regfile: RESET FAILED: MEPC\n",
                  64,VL_TIME_UNITED_Q(1000),-9,vlSymsp->name());
    ...
    co_await vlSelf->__VdlySched.delay(0x3e8ULL, nullptr, 
                                       ...
                                       164);
    if (VL_UNLIKELY((0U != vlSelf->tb_csr_regfile__DOT__csr_rdata))) {
        VL_WRITEF("[%0t] %%Fatal: tb_csr_regfile.v:166: Assertion failed in %Ntb_csr_regfile: RESET FAILED: MCAUSE\n",
                  64,VL_TIME_UNITED_Q(1000),-9,vlSymsp->name());
        VL_STOP_MT("tb/tb_csr_regfile.v", 166, "");
    }
    VL_WRITEF("ALL TESTS PASSED\n");
    VL_FINISH_MT("tb/tb_csr_regfile.v", 170, "");
}
...
void Vtb_csr_regfile___024root___eval_triggers__act(Vtb_csr_regfile___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtb_csr_regfile__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_csr_regfile___024root___eval_triggers__act\n"); );
    // Body
